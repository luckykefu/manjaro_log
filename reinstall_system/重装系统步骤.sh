...
# keepassxc    : /data/.manjaro/backup_data
# clash-verge  : sub link : https://zhuzhuzhu.whtjdasha.com/api/v1/client/subscribe?token=eebe36f8c2eb695b9841a61eb4b03825
#                setting  : auto start; silent start; allow lan
...
## 安装软件
sudo pacman -S --needed --noconfirm \
    haveged aria2 mpv ffmpeg \
    telegram-desktop obs-studio qbittorrent \
    ventoy nodejs npm unzip
